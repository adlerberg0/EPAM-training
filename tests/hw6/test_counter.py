...
def test_decorator_is_counting_instances(user_class):
    ...
    instance_count_after_reset = user.reset_instances_counter()

    assert instance_count_from_class == 0
    assert instance_count_from_instance == 3
    assert instance_count_after_reset == 3
